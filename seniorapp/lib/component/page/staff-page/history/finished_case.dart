...
class _StaffFinishedCaseState extends State<StaffFinishedCase> {
  ...
  List<Map<String, dynamic>> finishedCaseList = [];
  ...
  addData() {
    List<Map<String, dynamic>> combinedList =
        finishedHealthCaseList + finishedPhysicalCaseList;
  ...
  Widget build(BuildContext context) {
    ...
    finishedCaseList = add_filter(finishedCaseList);
    finishedCaseList = add_sort(finishedCaseList);
          ...
          children: [
            ...
            Expanded(
              child: isLoading == true
                  ...
                  : finishedCaseList.isNotEmpty
                      ? ListView.builder(
                          itemCount: finishedCaseList.length,
                          itemBuilder: (BuildContext context, int index) {
                            Map<String, dynamic> data = finishedCaseList[index];
